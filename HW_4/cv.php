    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-hourglass fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $age_year?> лет (<?php echo $age_days?> дней)</p>
          <hr>

          <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Навыки</b></p>
          <p><?php echo $skill_name[0]?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skill_level[0]?>%"><?php echo $skill_level[0]?>%</div>
          </div>
          <p><?php echo $skill_name[1]?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skill_level[1]?>%">
              <div class="w3-center w3-text-white"><?php echo $skill_level[1]?>%</div>
            </div>
          </div>
          <p><?php echo $skill_name[2]?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skill_level[2]?>%"><?php echo $skill_level[2]?>%</div>
          </div>
          <p><?php echo $skill_name[3]?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skill_level[3]?>%"><?php echo $skill_level[3]?>%</div>
          </div>
          <br>
